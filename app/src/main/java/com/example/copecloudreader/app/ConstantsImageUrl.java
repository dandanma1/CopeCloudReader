...
public class ConstantsImageUrl {
    ...
    public static final String[] TRANSITION_URLS={TRANSITION_URL_01,
            TRANSITION_URL_02,TRANSITION_URL_03,TRANSITION_URL_04,
            TRANSITION_URL_05,TRANSITION_URL_06,TRANSITION_URL_07,
